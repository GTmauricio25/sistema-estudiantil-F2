                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Resultados de la busqueda </h2>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Resultados del estudiante</h3>
                                                    <hr/>
<?php
// codigo datos del estudiante
$rollid=$_POST['rollid'];
$classid=$_POST['class'];
...
<p><b>ID del estudiante :</b> <?php echo htmlentities($row->RollId);?>
<p><b>Clase del estudiante:</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
...
?>
<tr>
<th scope="row" colspan="2" style="text-align: center">Total de puntos</th>
<td style="text-align: center"><b><?php echo htmlentities($totlcount); ?></b> de <b><?php echo htmlentities($outof=($cnt-1)*10); ?></b></td>
                                                        </tr>
<tr>
<th scope="row" colspan="2" style="text-align: center">Nota total de periodo</th>           
<td style="text-align: center"><b><?php echo  htmlentities($totlcount*(10)/$outof); ?> / 10</b></td>
</tr>
...
<div class="alert alert-warning left-icon-alert" role="alert">
                                            <strong>Aviso!</strong> Tu resultado no ha sido encontrado
 <?php }
?>
                                        </div>
 <?php 
...
Algo salio mal! Ingresa un ID valido.</strong>
<?php
