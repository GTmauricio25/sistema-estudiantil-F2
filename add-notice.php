...
<?php include('includes/leftbar.php');?>                   
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Añadir noticia</h2>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Titulo de la noticia</label>
                                                		<div class="">
                                                			<input type="text" name="noticetitle" class="form-control" required="required" id="noticetitle">
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Detalles de la noticia</label>
                                                        <div class="">
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-success">Subir noticia</button>
                                                    </div>
